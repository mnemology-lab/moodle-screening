...
// --- Moodle Items ---
const moodle_items = [
    { stimulus: 'tomatoesmoonified.jpg', correct_category_key: '1', correct_object_key: '3', category_choices: '1) plant or food\n2) insect\n3) reptile\n4) household item\n5) mammal', object_choices: '1) bunny\n2) wheat\n3) tomatoes\n4) pretzel\n5) crocodile' },
    { stimulus: '0_pumpkin2moonified.jpg', correct_category_key: '1', correct_object_key: '3', category_choices: '1) plant or food\n2) mammal\n3) reptile\n4) household item\n5) bird', object_choices: '1) spider\n2) cactus\n3) pumpkin\n4) clown\n5) octopus' },
    ...
    { stimulus: '0_snake2_new_gauss2.jpg', correct_category_key: '5', correct_object_key: '2', category_choices: '1) plant or food\n2) insect\n3) bird\n4) household item\n5) reptile', object_choices: '1) sailing boat\n2) snake\n3) tooth brush\n4) duck\n5) beetle' },
...
const final_redirect = {
    ...
    on_finish: () => {
        ...
        moodleAttempts.values().forEach(imgTrial => {
            ...
            // Look for trials that happened immediately after this trial index
        ...
        // Truncate to prevent URL breakage if participant types an essay
